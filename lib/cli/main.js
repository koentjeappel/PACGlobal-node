...
var pacglobalnode = require('..');
var utils = require('../utils');

function main(servicesPath, additionalServices) {
  /* jshint maxstatements: 100 */

  var version = pacglobalnode.version;
  var create = pacglobalnode.scaffold.create;
  var add = pacglobalnode.scaffold.add;
  var start = pacglobalnode.scaffold.start;
  var remove = pacglobalnode.scaffold.remove;
  var callMethod = pacglobalnode.scaffold.callMethod;
  var findConfig = pacglobalnode.scaffold.findConfig;
  var defaultConfig = pacglobalnode.scaffold.defaultConfig;
  ...
  program
    ...
    .option('-d, --datadir <dir>', 'Specify the Pacglobal database directory')
  ...
  program
    ...
    .option('-d, --daemon', 'Make pacglobal-node a daemon (running in the background)')
    .action(function(cmd){
      if (cmd.config) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `pacglobal-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ pacglobal-node add wallet-service');
      console.log('    $ pacglobal-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ pacglobal-node remove wallet-service');
      console.log('    $ pacglobal-node remove insight-api');
      console.log();
    });
